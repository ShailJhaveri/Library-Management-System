...
<button  type="submit">Options</button>
 ...
 <form method="post" action ="PayFines" name="myform">
...
<input type="text" class="form-control" name="card_id" placeholder="Card ID" required>


            


<button class="fsSubmitButton" type="submit">Show Fines</button>
...
<td align="center">Total Fine</td>

<td align="center">Pay </td></tr>
...
<td align="center"><c:out value="${resulrVar.totalAmt}" /></td>

<td align = "center"><a href="PayFine_update?card_id=${resulrVar.card_id}"><input type="button" value="Pay"></a></td>
